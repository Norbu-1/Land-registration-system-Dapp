      ...
      <div className="App">
          <div className='container mainDiv'>
                <div className='landingPage-heading-div'>
                    ...
                    <h1>Blockchain-based Land Registration</h1>
                </div>
                <hr/>
                <div className='front'>
                  <div >
                <p className='welcome-p'>Welcome<br/> Securely verify, register and transfer land ownership with ease.</p>
                <button className='landingPage-btn' onClick={connectToEthereum}>Sign In</button>
                </div>
                <img src={image} alt="emblem" className="desk" />
                </div>
            </div>
        </div>
      }/>
